...
const INITIAL_CMS: CmsItem[] = [
  {
    ...
    label: 'Hero Title',
    page: 'Home Page',
    content: 'Find Your Dream Job in the UAE',
    published: true,
    versions: [
      { id: 1, content: 'Find Your Dream Job in the UAE', savedAt: '2026-06-10 14:30', savedBy: 'Super Admin' },
      { id: 2, content: 'Discover Top Jobs Across UAE', savedAt: '2026-06-01 09:15', savedBy: 'Content Editor' },
    ],
  },
  {
    ...
    label: 'Hero Subtitle',
    page: 'Home Page',
    content: 'Browse thousands of verified job listings across UAE — Dubai, Abu Dhabi, Sharjah and all emirates.',
    published: true,
    versions: [
      { id: 1, content: 'Browse thousands of verified job listings across UAE — Dubai, Abu Dhabi, Sharjah and all emirates.', savedAt: '2026-06-10 14:31', savedBy: 'Super Admin' },
    ],
  },
  {
  ...
  },
  {
    ...
    page: 'Global',
    content: "Your trusted partner in the UAE job market.",
    published: true,
    versions: [{ id: 1, content: "Your trusted partner in the UAE job market.", savedAt: '2026-06-01 09:15', savedBy: 'Super Admin' }],
  },
  {
  ...
  },
  {
    ...
    page: 'About Page',
    content: 'Our mission is to connect talented professionals with leading employers across the UAE — from Dubai to Abu Dhabi, Sharjah to RAK, fostering career growth and economic development.',
    published: true,
    versions: [{ id: 1, content: 'Our mission is to connect talented professionals with leading employers across the UAE — from Dubai to Abu Dhabi, Sharjah to RAK, fostering career growth and economic development.', savedAt: '2026-06-01 09:15', savedBy: 'Super Admin' }],
  },
  {
